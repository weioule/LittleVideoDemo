...
public class ProgressView extends View {
    ...
    public ProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        String color = typedArray.getString(R.styleable.ProgressView_progressColors);
        mDefaultWidth = (int) typedArray.getDimension(R.styleable.ProgressView_minWidth, 100);
        mDefaultHeight = (int) typedArray.getDimension(R.styleable.ProgressView_minHeight, 5);
        mMinProgressWidth = (int) typedArray.getDimension(R.styleable.ProgressView_minProgressWidth, 100);
