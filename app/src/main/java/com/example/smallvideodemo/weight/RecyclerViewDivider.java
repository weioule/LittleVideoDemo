...
public class RecyclerViewDivider extends RecyclerView.ItemDecoration {
    ...
    public static final int GRIDEVIDW = 888;
    ...
    public void setOrientation() {
        ...
        if (orientation != HORIZONTAL && orientation != VERTICAL && orientation != GRIDEVIDW) {
